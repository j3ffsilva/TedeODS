...
def verifica_expressao(texto):
    ...
    # Exceções (não pode conter "paleoclima", "paleoceanografia", "radiocarbono", "genética", "medicina", "droga", "engenharia", "aerossol")
    if re.search(r'paleoclima|paleoceanografia|radiocarbono|gen[ée]tica|medicina|droga|engenharia|aerossol', texto):
        return False, None
